 ...
 * this in our code is to use if-elseif-else statements.
 * 
 ...
 * evaluates to true. 
 * 
 * 2. Following the inital if statement (which you only need one of), you can then
 ...
 * 
 * 3. else statements end the entire if-elseif-else statement. They act as the 
 ...
 * 
 * 4. switch statements act as a shorter and cleaner alternative to if-elseif-else 
