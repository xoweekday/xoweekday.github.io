 ...
 * 
 * When creating a function definition, you start by using the keyword function,
 ...
 * undefined. 
 * 
 * In order to use a function, you have to call it. You can think of it as if
...
/**
 * Creating a named function is very similar to the function definition from
...
/**
 * Creating a function expression is different in the fact that you assign
 ...
 */
 ...
 /**
 * Arrow functions were introduced in the recent ES6 update, that simply offer
...
/**
 * In JavaScript, scope determines when and where variables are accessible in a 
 ...
 */
 ...
 /**
  * NOTE: Notice that the global variable value is logged on line 130 instead
