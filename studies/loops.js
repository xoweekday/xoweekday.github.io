 ...
 * 
 * 1. For loops are especially helpful when a programmer knows the exact number
 ...
 * 
 * 2. For-in loops are used to iterate over objects, and pull out all of an object's
